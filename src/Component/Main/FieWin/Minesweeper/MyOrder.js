                                        ...
                                        <div className="css-1dbjc4n r-1awozwy r-18u37iz" style={{ padding: "18px 18px 0px" }}>
                                            ...
                                            <div className="css-1dbjc4n r-13awgt0 r-1pi2tsx r-a2tzq0 r-ltgprq">
                                                <div className="css-1dbjc4n r-18u37iz">
                                                    ...
                                                    <div dir="auto" className="css-901oao r-13awgt0 r-1i10wst" style={{ color: "rgb(151, 151, 151)", marginLeft: "100px" }}>Pass</div>
                                                ...
                                                <div className="css-1dbjc4n r-18u37iz">
                                                    ...
                                                    <div dir="auto" className="css-901oao r-5zpi7z r-13awgt0 r-evnaw" style={{ marginLeft: "100px" }}>{data.select}</div>
                                                    {data.status == 1 ?
