    ...
    return (
        <>
            <div className="css-1dbjc4n r-14lw9ot r-kdyh1x r-1s2bzr4 r-1ehh1yr r-12v598i">
                ...
                <div dir="auto" className="css-901oao r-1i88nnc r-evnaw r-l71dzp" style={{ marginBottom: "2px" }}>Invite 50 effective user to receive it.</div>
